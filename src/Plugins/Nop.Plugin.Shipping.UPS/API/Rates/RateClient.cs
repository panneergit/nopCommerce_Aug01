...
namespace Nop.Plugin.Shipping.UPS.API.Rates
{
    ...
    public partial class RateClient
    {
        ...
        /// </summary>
        /// <param name="version">Indicates Rate API to display the new release features in 
        /// <br/>Rate API response based on Rate release. See the New 
        /// <br/>section for the latest Rate release. Supported values: v1, 
        /// <br/>v1601, v1607, v1701, 1801. Length 5</param>
        /// <param name="requestoption">Valid Values: 
        /// <br/>Rate = The server rates (The default Request option is 
        /// <br/>Rate if a Request Option is not provided). 
        /// <br/>Shop = The server validates the shipment, and returns 
        /// <br/>rates for all UPS products from the ShipFrom to the 
        /// <br/>ShipTo addresses. 
        /// <br/>Rate is the only valid request option for Ground Freight 
        /// <br/>Pricing requests. . Length 10</param>
        ...
        /// <param name="additionalinfo">Valid Values: 
        /// <br/>timeintransit = The server rates with transit time 
        /// <br/>information combined with requestoption in URL.
        /// <br/>Rate is the only valid request option for Ground Freight 
        /// <br/>Pricing requests. Length 15</param>
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<RATEResponseWrapper> RatingAsync(string version, string requestoption, RATERequestWrapper body, string transId = null, string transactionSrc = null, string additionalinfo = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (version == null)
    ...
    {
        /// <summary>
        /// Pickup Type Code.  Valid values: 
        /// <br/>01 - Daily Pickup (Default - used when an invalid pickup type code is provided)
        /// <br/>03 - Customer Counter
        /// <br/>06 - One Time Pickup
        /// <br/>19 - Letter Center
        /// <br/>20 - Air Service Center
        /// <br/>Length is not validated. 
        /// <br/>When negotiated rates are requested, 07 (onCallAir) will be ignored.
        /// <br/>
        /// <br/>Refer to the Rate Types Table in the Appendix for rate type based on Pickup Type and Customer Classification Code.
        /// </summary>
    ...
    {
        /// <summary>
        /// Customer classification code.  Valid values:
        /// <br/>00 -  Rates Associated with Shipper Number
        /// <br/>01 -  Daily Rates
        /// <br/>04 -  Retail Rates
        /// <br/>05 - Regional Rates
        /// <br/>06 - General List Rates
        /// <br/>53 -  Standard List Rates
        /// <br/>Length is not validated.
        /// <br/>If customer classification code is not a valid value please refer to Rate Types Table on page 11.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Code", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Code { get; set; }
    ...
    public partial class RateRequest_Shipment
    {
        ...
        /// <summary>
        /// Presence/Absence Indicator. Any value inside is ignored. TaxInformationIndicator is an indicator. 
        /// <br/>
        /// <br/>The Tax related information includes any type of Taxes, corresponding Monetary Values, Total Charges with Taxes and disclaimers (if applicable) would be returned in response.  If present, any taxes that may be applicable to a shipment would be returned in response. 
        /// <br/>
        /// <br/>If this indicator is requested with NegotiatedRatesIndicator, Tax related information, if applicable, would be returned only for Negotiated Rates and not for Published Rates.
        /// </summary>
    ...
    public partial class ShipTo_Address
    {
        ...
        /// <summary>
        /// Presence/Absence Indicator. Any value inside is ignored.This field is a flag to indicate if the Alternate Delivery location is a residential location. 
        /// <br/>True if ResidentialAddressIndicator tag exists.  For future use.
        /// </summary>
    ...
    public partial class Shipment_PaymentDetails
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public PaymentDetails_ShipmentCharge ShipmentCharge { get; set; } = new PaymentDetails_ShipmentCharge();
    ...
    public partial class Shipment_FreightShipmentInformation
    {
        ...
        /// <br/>For Density Based Rating (DBR), the customer must have DBR Contract Service.
        /// </summary>
    ...
    public partial class FreightShipmentInformation_FreightDensityInfo
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public FreightDensityInfo_HandlingUnits HandlingUnits { get; set; } = new FreightDensityInfo_HandlingUnits();
    ...
    public partial class Commodity_NMFC
    {
        ...
        /// <summary>
        /// Value of NMFC Sub. Contact your service representative if you need information concerning NMFC Codes.  Needs to be provided when the SubCode associated with the PrimeCode is other than 00. 
        /// <br/>API defaults the sub value to 00 if not provided. 
        /// <br/>If provided the Sub Code should be associated with the PrimeCode of the NMFC.
        /// </summary>
    ...
    public partial class Package_PackageServiceOptions
    {
        ...
        /// <br/>
        /// <br/>If present, the package is rated for UPS Proactive Response and proactive package tracking.
        /// <br/>
        /// <br/>Contractual accessorial for health care companies to allow package monitoring throughout the UPS system.  Shippers account needs to have valid contract for UPS Proactive Response.
        /// </summary>
    ...
    public partial class PackageServiceOptions_DeliveryConfirmation
    {
        ...
        /// <br/>1 - Delivery Confirmation Signature Required 
        /// <br/>2 - Delivery Confirmation Adult Signature Required
        /// </summary>
    ...
    /// <summary>
    /// Access Point COD indicates Package COD is requested for a shipment.  Valid only for : 01 - Hold For Pickup At UPS Access Point, Shipment Indication type. 
    /// <br/>Package Access Point COD is valid only for shipment without return service from US/PR to US/PR and CA to CA. 
    /// <br/>Not valid with (Package) COD.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <summary>
    /// COD Container. Indicates COD is requested.   Valid for the following country or territory combinations: 
    /// <br/>US/PR to US/PR
    /// <br/>CA to CA
    /// <br/>CA to US
    /// <br/>Not allowed for CA to US for packages that are designated as Letters or Envelopes.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class PackageServiceOptions_HazMat
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public HazMat_HazMatChemicalRecord HazMatChemicalRecord { get; set; } = new HazMat_HazMatChemicalRecord();
    ...
    public partial class HazMat_HazMatChemicalRecord
    {
        ...
        /// <summary>
        /// The method of transport by which a shipment is approved to move and the regulations associated with that method.  Only required when the CommodityRegulatedLevelCode is FR or LQ.
        /// <br/>Valid values: 
        /// <br/>01 - Highway
        /// <br/>02 - Ground
        /// <br/>03 - Passenger Aircraft
        /// <br/>04 - Cargo Aircraft Only  Applies only if SubVersion is greater than or equal to 1701. For multiple ChemicalRecords per package having different TransportationMode, TransportationMode of first ChemicalRecord would be considered for validating and rating the package. All TransportationMode except for '04' are general service offering. If any chemical record contains '04' as TransportationMode, ShipperNumber needs to be authorized to use '04' as TransportationMode.
        /// </summary>
        ...
        /// <br/>Valid values for this field are (0) through (9) with trailing blanks. For numbers within the U.S., the layout is '1', area code, 7-digit number. For all other countries or territories the layout is country or territory code, area code, number.  Applies only if SubVersion is greater than or equal to 1701.
        /// </summary>
        ...
        /// <summary>
        /// This is the packing group category associated to the specified commodity. Required if CommodityRegulatedLevelCode = LQ or FR and if the field applies to the material by regulation. Must be shown in Roman Numerals.
        /// <br/>Valid values are:
        /// <br/>I, 
        /// <br/>II,
        /// <br/>III,
        /// <br/>blank.   Applies only if SubVersion is greater than or equal to 1701.
        /// </summary>
        ...
        /// <br/>Valid values are 1 to 999.  Applies only if SubVersion is greater than or equal to 1701.
        /// </summary>
        ...
        /// <br/>FR, 
        /// <br/>LQ, 
        /// <br/>EQ.   Applies only if SubVersion is greater than or equal to 1701.
        /// </summary>
        ...
        /// <summary>
        /// Transport Category.
        /// <br/>Valid values are 0 to 4.  Applies only if SubVersion is greater than or equal to 1701.
        /// </summary>
    ...
    public partial class PackageServiceOptions_DryIce
    {
        ...
        /// <br/>Valid values: 
        /// <br/>CFR = For HazMat regulated by US Dept of Transportation within the U.S. or ground shipments to Canada,
        /// <br/>IATA = For Worldwide Air movement.   The following values are valid: CFR and IATA.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("RegulationSet", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string RegulationSet { get; set; }
    ...
    public partial class DryIce_DryIceWeight
    {
        ...
        /// <summary>
        /// Weight for Dry Ice.  Cannot be more than package weight. 
        /// <br/>Should be more than 0.0. 
        /// <br/>Valid characters are 0-9 and "." (Decimal point). 
        /// <br/>Limit to 1 digit after the decimal. 
        /// <br/>The maximum length of the field is 5 including "." and can hold up to 1 decimal place.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Weight", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Weight { get; set; }
    ...
    {
        /// <summary>
        /// UPS Premier Category  Valid values are 01,02,03                        
        /// <br/>UPS Premier Silver - 01
        /// <br/>UPS Premier Gold - 02
        /// <br/>UPS Premier Platinum - 03
        /// </summary>
    ...
    public partial class Shipment_ShipmentServiceOptions
    {
        ...
        /// <summary>
        /// If we need diferent available services in response, this option is used for shop request option. SaturdayDeliveryIndicator/ SundayDeliveryIndicator will be ignored in that case.  Valid Values:
        /// <br/>1- Weekday+Saturday services
        /// <br/>2- Weekday+Sunday services
        /// <br/>3- Weekday+Sat services+Sun services
        /// </summary>
        ...
        /// <br/>01 - Hold For Pickup At UPS Access Point 02 - UPS Access Point� Delivery"
        /// </summary>
        ...
        /// <summary>
        /// Presence/Absence Indicator. Any value inside is ignored. 
        /// <br/>CommercialInvoiceRemovalIndicator - empty tag means indicator is present. 
        /// <br/>CommercialInvoiceRemovalIndicator allows a shipper to dictate that UPS remove the Commercial Invoice from the user's shipment before the shipment is delivered to the ultimate consignee.
        /// </summary>
        ...
        /// <summary>
        /// Empty Tag means the indicator is present. This field is a flag to indicate if the receiver needs SDL rates in response. True if SDLShipmentIndicator tag exists; false otherwise.  If present, the State Department License (SDL) rates will be returned in the response.
        /// <br/>
        /// <br/>This service requires that the account number is enabled for SDL.
        /// </summary>
        ...
        /// <summary>
        /// Presence/Absence Indicator. Any value inside is ignored. This field is a flag to indicate Package Release Code is requested for shipment. 
    ...
    /// <summary>
    /// If present, indicates C.O.D. is requested for the shipment.  Shipment level C.O.D. is only available for EU origin countries or territories.
    /// <br/>C.O.D. shipments are only available for Shippers with Daily Pickup and Drop Shipping accounts.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <summary>
    /// Delivery Confirmation Container.  DeliveryConfirmation and C.O.D. are mutually exclusive. 
    /// <br/>
    /// <br/>Refer to the Appendix for a list of valid origin-destination country or territory pairs associated with each confirmation type.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class ShipmentServiceOptions_ImportControl
    {
        ...
        /// <br/>Valid values are: 
        /// <br/>'01' = ImportControl Print and Mail 
        /// <br/>'02' = ImportControl One-Attempt                                     '03' = ImportControl Three-Attempt
        /// <br/>'04' = ImportControl Electronic Label 
        /// <br/>'05' = ImportControl Print Label.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Code", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Code { get; set; }
    ...
    public partial class ShipmentServiceOptions_ReturnService
    {
        ...
        /// <br/>Valid values are:
        /// <br/>'2' = UPS Print and Mail Return Label 
        /// <br/>'3' =UPS One-Attempt Return Label
        /// <br/>'5' = UPS Three Attempt Return Label
        /// <br/>'8' = UPS Electronic Return Label
        /// <br/>'9' = UPS Print Return Label
        /// <br/>'10' = UPS Exchange Print Return Label                            '11' = UPS Pack &amp; Collect Service 1-Attempt Box 1
        /// <br/> '12' = UPS Pack &amp; Collect Service 1-Attempt Box 2
        /// <br/> '13' = UPS Pack &amp; Collect Service 1-Attempt Box 3
        /// <br/> '14' = UPS Pack &amp; Collect Service 1-Attempt Box 4
        /// <br/> '15' = UPS Pack &amp; Collect Service 1-Attempt Box 5
        /// <br/> '16' = UPS Pack &amp; Collect Service 3-Attempt Box 1
        /// <br/> '17' = UPS Pack &amp; Collect Service 3-Attempt Box 2
        /// <br/> '18' = UPS Pack &amp; Collect Service 3-Attempt Box 3
        /// <br/> '19' = UPS Pack &amp; Collect Service 3-Attempt Box 4
        /// <br/> '20' = UPS Pack &amp; Collect Service 3-Attempt Box 5
        /// <br/>  10 = UPS Exchange Print Return Label and 5 = UPS Three Attempt Return Label are not valid for UPS WorldWide Express Freight and UPS Worldwide Express Freight Midday Services. 
        /// <br/>
        /// <br/>3 = UPS One-Attempt Return Label is not valid return service with UPS Premium Care accessorial.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Code", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Code { get; set; }
    ...
    {
        /// <summary>
        /// NegotiatedRatesIndicator -  Required to display two types of discounts: 
        /// <br/>1) Bids or Account Based Rates
        /// <br/>2) Web/Promotional Discounts Bids
        /// <br/>
        /// <br/>Account Based Rates: If the indicator is present, the Shipper is authorized, and the Rating API XML Request is configured to return Negotiated Rates, then Negotiated Rates should be returned in the response. 
        /// <br/>
        /// <br/>Web/Promotional Discounts: If the indicator is present, the Shipper is authorized for Web/Promotional Discounts then Negotiated Rates should be returned in the response.
        /// </summary>
        ...
        /// <br/>
        /// <br/>For 3P/FC shipment if the shipper wishes to request for the negotiated rates of the third party then this indicator should be included in the request. 
        /// <br/>
        /// <br/>If authorized the 3P/FC negotiated rates will be applied to the shipment and rates will be returned in response.
        /// </summary>
    ...
    /// <summary>
    /// Container to hold InvoiceLineTotal Information.  Required if the shipment is from US/PR Outbound to non US/PR destination with the PackagingType of UPS PAK(04).
    /// <br/>
    /// <br/>Required for international shipments 
    /// <br/>when using request option "ratetimeintransit" or "shoptimeintransit".
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class RateResponse_Response
    {
        ...
        public Response_AlertDetail AlertDetail { get; set; }
    ...
    public partial class RateResponse_RatedShipment
    {
        ...
        /// <summary>
        /// Indicates whether the billable weight calculation method is utilized at the package or shipment level.  This information will be returned only if RatingMethodRequestedIndicator is present in the request.  Possible values:
        /// <br/>01 = Shipment Billable Weight
        /// <br/>02 = Package Billable Weight
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the Shipment was rated at the shipment-level or the package-level. This information will be returned only if RatingMethodRequestedIndicator is present in the request.  Possible values:
        /// <br/>01 = Shipment level
        /// <br/>02 = Package level
        /// </summary>
    ...
    public partial class RatedShipment_FRSShipmentData
    {
        ...
        public FRSShipmentData_HandlingUnits HandlingUnits { get; set; }
    ...
    public partial class FRSShipmentData_FreightDensityRate
    {
        ...
        /// <br/>Valid values:0 to 99999.999
        /// </summary>
    ...
    public partial class RatedShipment_RatedPackage
    {
        ...
        public RatedPackage_RateModifier RateModifier { get; set; }
    ...
    /// <summary>
    /// Negotiated Rates container.  These charges would be returned only when -
    /// <br/>1) subversion is greater than or equal to 1607
    /// <br/>2) if negotiated rates were requested for GFP shipments and account number is eligible to receive negotiated rates.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class RatedShipment_TimeInTransit
    {
        ...
        /// <summary>
        /// Package bill type for the shipment. Valid values:
        /// <br/>02 - Document only 
        /// <br/>03 - Non-Document
        /// <br/>04 - Pallet
        /// </summary>
        ...
        /// <summary>
        /// Required output for International requests. If Documents indicator is set for Non-document a duty is automatically calculated. The possible values to be returned are: 
        /// <br/>01 - Dutiable
        /// <br/>02 - Non-Dutiable
        /// <br/>03 - Low-value
        /// <br/>04 - Courier Remission
        /// <br/>05 - Gift
        /// <br/>06 - Military
        /// <br/>07 - Exception
        /// <br/>08 - Line Release
        /// <br/>09 - Section 321 low value.
        /// </summary>
    ...
    public partial class TimeInTransit_ServiceSummary
    {
        ...
        /// <summary>
        /// Saturday delivery information for a service. Values are
        /// <br/>1 - Saturday Delivery Available with additional charges 
        /// <br/>0 - Saturday Delivery not available or no additional charge, please check Delivery Date to confirm if the Delivery will be Saturday
        /// <br/>
        /// <br/>Please see Saturday Delivery business rules section for more information.
        /// </summary>
        ...
        /// <summary>
        /// Sunday delivery information for a service. Values are
        /// <br/>1 - Sunday Delivery Available with additional charges 
        /// <br/>0 - Sunday Delivery not available or no additional charge, please check Delivery Date to confirm if the Delivery will be Sunday
        /// <br/>
        /// <br/>Please see Saturday Delivery business rules section for more information.
        /// <br/>  Applies only if SubVersion is greater than or equal to 2007
        /// </summary>
    ...
    public partial class ServiceSummary_EstimatedArrival
    {
        ...
        /// <summary>
        /// Day of week for arrival. Valid values are: 
        /// <br/>MON
        /// <br/>TUE
        /// <br/>WED
        /// <br/>THU
